...
/* Board */
#define AQ_STATUS_W_BATT_LOW			0x00000001
#define AQ_STATUS_U_REQ_USB			0x00000002
#define AQ_STATUS_U_REQ_USER_INPUT		0x00000004

/* Networking/WiFi */
#define AQ_STATUS_W_WIFI_DISCONNECTED		0x01000000
#define AQ_STATUS_I_CLIENT_CONNECTED		0x02000000
#define AQ_STATUS_E_WIFI_FAIL			0x04000000

/* BME280 Temp/Humidity/Pressure */
#define AQ_STATUS_E_BME280_COMM_FAIL		0x00010000
#define AQ_STATUS_E_BME280_SLEEP_FAIL		0x00020000
#define AQ_STATUS_E_BME280_NVM_FAIL		0x00040000
#define AQ_STATUS_E_BME280_NOT_FOUND		0x00080000
#define AQ_STATUS_E_BME280_GENERAL_FAIL		0x00100000
#define AQ_STATUS_W_BME280_OSR_INVALID		0x00200000
#define AQ_STATUS_I_BME280_READING		0x00400000

/* BME680 Gas Sensor */
#define AQ_STATUS_E_BME680_SELFTEST_FAIL	0x00000100
#define AQ_STATUS_E_BME680_COMM_FAIL		0x00000200
#define AQ_STATUS_E_BME680_GENERAL_FAIL		0x00000400
#define AQ_STATUS_W_BME680_GAS_INVALID		0x00000800
#define AQ_STATUS_W_BME680_GAS_UNSTABLE		0x00001000
#define AQ_STATUS_I_BME680_READING		0x00002000

/* PM2.5 Particle sensor */
#define AQ_STATUS_E_PM2_5_COMM_FAIL		0x00000010
#define AQ_STATUS_E_PM2_5_GENERAL_FAIL		0x00000020
#define AQ_STATUS_W_PM2_5_NO_DATA		0x00000040
#define AQ_STATUS_I_PM2_5_READING		0x00000080
...
#define AQ_STATUS_REGION_BOARD			0x0000000f
#define AQ_STATUS_REGION_WIFI			0xff000000
#define AQ_STATUS_REGION_BME280			0x00ff0000
#define AQ_STATUS_REGION_BME680			0x0000ff00
#define AQ_STATUS_REGION_PM2_5			0x000000f0
